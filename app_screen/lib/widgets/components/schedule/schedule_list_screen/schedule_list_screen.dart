...
class ScheduleListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StateNotifierProvider<ScheduleListScreenController, ScheduleListScreenState>(
      create: (_) => ScheduleListScreenController(
        context: context,
      ),
      builder: (context, _) {
        List<ScheduleItemModel> schedule = context.select<ScheduleListScreenState, List<ScheduleItemModel>>((state) => state.schedules);
            ...
            itemBuilder: (_, index) {
              return Container(
                child: Row(
                  children: [
                    Text(
                      scheduleListData[index].scheduleName,
